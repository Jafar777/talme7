              ...
              <div className="space-y-6 text-foreground/90 leading-relaxed">
                <div>
                  ...
                  <ul className="list-disc pr-5 space-y-2">
                    <li>
                      يتم تقسيم ستة لاعبين أو أكثر إلى فريقين، يُشار إلى أحدهما
                      باسم الفريق أ والآخر باسم الفريق ب.
                    </li>
                    <li>
                      توضع 500 بطاقات في حامل البطاقات، ويختار الفريق أ شخصًا من
                      مجموعته ليكون مُعطي التلميح.
                    </li>
                    <li>
                      يأخذ هذا الشخص حامل البطاقات ويضع البطاقة الأولى بعيدًا عن
                      فريقه بحيث لا يتمكنون من رؤيتها.
                    </li>
                  </ul>
                  <p className="mt-3">
                    تحتوي بطاقات التلميح على كلمة التلميح في أعلى البطاقة،
                    وتُدرج الكلمات المحظورة أسفل كلمة التلميح. يبدأ مُعطو
                    التلميح اللعب، ويتولّون تشغيل المؤقّت، ويجب عليهم جعل فريقهم
                    ينطق كلمة التخمين الموجودة على البطاقة دون استخدام أي من
                    الكلمات المحظورة في تلميحاتهم. إذا تم استخدام كلمة محظورة،
                    يجب على الفريق ب الضغط على الجرس، مما يعاقب الفريق أ بوضع
                    بطاقة التخمين الحالية في كومة البطاقات المستبعَدة.
                  </p>
                  <p className="mt-3">
                    يستمر اللعب حتى ينتهي الوقت. في كل مرة ينجح أحد أعضاء الفريق
                    في تخمين كلمة التلميح بنجاح، توضع بطاقة جديدة فوق السابقة،
                    وتمثّل كل بطاقة في هذه الكومة نقطة واحدة للفريق أ.
                  </p>
                </div>

                <div>
                  <h3 className="text-xl font-bold mb-3 text-primary">
                    طريقة اللعب وتسجيل النقاط:
                  </h3>
                  <ul className="list-disc pr-5 space-y-2">
                    <li>
                      يجب على الفريق الذي لا يعطي التلميحات مراقبة أي استخدام
                      للكلمات المحظورة أو أي مخالفة أخرى للقواعد.
                    </li>
                    <li>
                      إذا نجحوا في اكتشاف مخالفة، يمكنهم استخدام الجرس لإيقاف
                      اللعب وشرح المخالفة بإيجاز شديد.
                    </li>
                    <li>
                      عندها يجب على مُعطي التلميح وضع البطاقة الحالية في كومة
                      البطاقات المستبعَدة وسحب بطاقة جديدة.
                    </li>
                    <li>
                      تمثّل كل بطاقة في كومة البطاقات المستبعَدة نقطة واحدة
                      للفريق الآخر.
                    </li>
                    <li>عند انتهاء الوقت، يتم تبديل الفرق وعكس الأدوار.</li>
                    <li>تنتهي اللعبة بعد أن يأخذ كل لاعب دوره كمُعطي تلميح.</li>
                    <li>
                      وإذا كان عدد اللاعبين في الفريقين غير متساوٍ، فإن لاعبًا
                      من الفريق الأصغر سيكون مُعطي تلميح مرتين.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pr-5 space-y-2">
                    <li>
                      لا يجوز لمُعطي التلميح استخدام أي من الكلمات المحظورة، بما
                      في ذلك الاختصارات أو أي جزء من الكلمة المحظورة.
                    </li>
                    <li>
                      لا يجوز لمُعطي التلميح استخدام المؤثرات الصوتية أو
                      الإشارات الجسدية للدلالة على كلمة التلميح.
                    </li>
                    <li>
                      يجوز لمُعطي التلميح تجاوز أي بطاقة في أي وقت، ولكن يتم
                      حينها وضع البطاقة في كومة البطاقات المستبعَدة.
                    </li>
                    <li>
                      عند الإعلان عن انتهاء الوقت، لا توضع البطاقة الأخيرة في
                      كومة البطاقات المستبعَدة، بل تُزال من اللعب.
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center justify-center space-y-12 md:space-y-16">
        ...
        <div className="text-center space-y-6 animate-fade-in">
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-foreground/70 leading-relaxed px-4">
              تحدَّ أصدقاءك في لعبة الذكاء والسرعة! احزر الكلمة دون استخدام
              الكلمات الممنوعة. هل تستطيع الفوز قبل انتهاء الوقت؟
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/30 text-center">
          <p className="text-foreground/50 text-sm">
            استمتع بلعب{" "}
            <span className="font-semibold text-primary">ممنوع</span> مع أصدقائك
